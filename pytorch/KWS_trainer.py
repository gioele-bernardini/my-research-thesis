...
def save_weights_16bit(model, directory='weights_16bit'):
    ...
    for name, layer in model.named_modules():
        # Save weights for Linear or BinarizeLinear layers
        ...
        # Salva BatchNorm1d parameters (in float16)
